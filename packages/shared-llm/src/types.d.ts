...
export type LLMTaskType = "classification" | "structured_extraction" | "content_generation" | "analysis" | "chat";
...
export declare class MissingProviderKeyError extends Error {
