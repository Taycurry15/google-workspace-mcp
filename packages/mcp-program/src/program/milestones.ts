...
export async function trackMilestone(
  ...
  if (params.status === "achieved" && milestoneData) {
    // Get milestone details from row data
    const milestone = {
      milestoneId: milestoneData[0],
      programId: milestoneData[1],
      name: milestoneData[4],
      owner: milestoneData[11],
      critical: milestoneData[12] === "Yes",
      deliverables: milestoneData[13] ? milestoneData[13].split(", ") : [],
    };
  ...
  if (params.status === "at_risk" && milestoneData) {
    const milestone = {
      milestoneId: milestoneData[0],
      programId: milestoneData[1],
      name: milestoneData[4],
      owner: milestoneData[11],
      targetDate: new Date(milestoneData[6]),
      critical: milestoneData[12] === "Yes",
    };
